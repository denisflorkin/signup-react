  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="28px" height="28px" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid">
      ...
      <g>
        ...
        <circle cx="50" cy="50" r="9.6142" stroke="#4e4e4e" fill="none" strokeWidth="4" strokeLinecap="round">
      ...
      <g>
        ...
        <circle cx="50" cy="50" r="32.3174" stroke="#4e4e4e" fill="none" strokeWidth="4" strokeLinecap="round">
